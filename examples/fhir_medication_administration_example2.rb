...
medication.code = build_codeable_concept('107750602', 'ソリタ－Ｔ３号輸液５００ｍＬ', 'urn:oid:1.2.392.100495.20.2.74')
...
medication = FHIR::Medication.new
medication.id = SecureRandom.uuid
medication.code = build_codeable_concept('108010001', 'アドナ注（静脈用）５０ｍｇ', 'urn:oid:1.2.392.100495.20.2.74')
ratio = FHIR::Ratio.new
