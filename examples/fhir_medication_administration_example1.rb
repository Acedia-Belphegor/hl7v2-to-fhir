...
extension.valueQuantity = build_quantity(1, '本', 'HON')
...
ingredient = FHIR::Medication::Ingredient.new
ingredient.itemCodeableConcept = build_codeable_concept('108010001', 'アドナ注（静脈用）５０ｍｇ', 'urn:oid:1.2.392.100495.20.2.74')

extension = FHIR::Extension.new
extension.url = "http://hl7fhir.jp/fhir/StructureDefinition/Extension-JPCore-ComponentAmount"
extension.valueQuantity = build_quantity(1, 'アンプル', 'AMP')
ingredient.extension << extension
